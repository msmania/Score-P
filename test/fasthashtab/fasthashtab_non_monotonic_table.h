...
/* Minimal header for the use case SCOREP_HASH_TABLE_NON_MONOTONIC_HEADER +
 * SCOREP_HASH_TABLE_NON_MONOTONIC_DEFINITION. */
...
/* You need declare required functions that are not intended to be
   inlined before using SCOREP_HASH_TABLE_NON_MONOTONIC_HEADER. */
...
SCOREP_HASH_TABLE_NON_MONOTONIC_HEADER( table,
                                        8,
