...
CONFIG	      += exceptions console rtti warn_on  release c++1z
TEMPLATE = app
CUBE +=
CUBE_SRC = ../../../../src/cube
...
CUBE_TOOL_SRC = ../../../../src/tools/tools/007b.Server
DEPENDPATH += $${COMMON_SRC} $${COMMON_SRC}/common_inc
INCLUDEPATH += \
     ../../include \
            $${CUBE_INFO_SRC} $${TOOLS_LIBRARY_SRC} $${COMMON_SRC}/common_inc  $${CUBE_SRC}/../../vpath/src/ $${CUBE_SRC}/../  \
...
# Input{
HEADERS +=   \
   $${CUBE_TOOL_SRC}/RequestTask.h \
   $${CUBE_TOOL_SRC}/ServerWorker.h
   $${CUBE_TOOL_SRC}/ThreadPool.h


SOURCES += \
   $${CUBE_TOOL_SRC}/ServerWorker.cpp \
   $${CUBE_TOOL_SRC}/ThreadPool.cpp \
   $${CUBE_TOOL_SRC}/cube4_server.cpp
