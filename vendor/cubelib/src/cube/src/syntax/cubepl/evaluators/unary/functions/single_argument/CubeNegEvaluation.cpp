...
double
NegEvaluation::eval( const cube::Cnode*       _cnode,
...
double*
NegEvaluation::eval_row( const Cnode*             _cnode,
                         const CalculationFlavour _cf ) const
{
...
double
NegEvaluation::eval( const list_of_cnodes&       lc,
                     const list_of_sysresources& ls ) const
{
    return Neg( arguments[ 0 ]->eval( lc, ls ) );
}
...
double*
NegEvaluation::eval_row( const list_of_cnodes&       lc,
                         const list_of_sysresources& ls ) const
{
