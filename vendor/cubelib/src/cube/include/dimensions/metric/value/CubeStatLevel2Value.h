...
#ifndef CUBELIB_STAT_LEVEL2_VALUE_H
#define CUBELIB_STAT_LEVEL2_VALUE_H
...
private:
    ...
    double
    calcAvg() const;                                                                  // /< Performs the calcualtion of Average

    double
    calcVar() const;                                                                  // /< Performs the calcualtion of Average
