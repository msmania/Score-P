...
#ifndef CUBELIB_ASSIGNMENT_EVALUATION_H
#define CUBELIB_ASSIGNMENT_EVALUATION_H 0
...
public:
    AssignmentEvaluation( std::string          _v,
                          ...
                          ) :  memory( _manager ), variable_name( _v ), variable( memory->register_variable( _v ) ), value( _val ), index( _index )
    {
