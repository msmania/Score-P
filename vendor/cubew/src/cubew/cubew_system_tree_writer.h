...
void
cube_system_tree_writer_write( cube_system_tree_writer* stwriter,
                               cube_meta_data_writer*   writer  );
void
cube_system_tree_writer_driver_write( cube_system_tree_writer* stwriter,
                                      cube_meta_data_writer*   writer );
...
void
cube_system_tree_writer_setup( cube_system_tree_writer*       stwriter,
