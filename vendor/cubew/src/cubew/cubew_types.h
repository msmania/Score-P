...
typedef enum cube_location_group_type { CUBE_LOCATION_GROUP_TYPE_PROCESS = 0, CUBE_LOCATION_GROUP_TYPE_METRICS = 1, CUBE_LOCATION_GROUP_TYPE_ACCELERATOR = 2 } cube_location_group_type;
 ...
 * Structure collection name, ID and rank of a location group.
 */
typedef enum cube_location_type { CUBE_LOCATION_TYPE_CPU_THREAD = 0, CUBE_LOCATION_TYPE_GPU = 1, CUBE_LOCATION_TYPE_ACCELERATOR_STREAM = 1, CUBE_LOCATION_TYPE_METRIC = 2 } cube_location_type;
